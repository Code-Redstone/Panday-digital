<template>
  <v-app>
      <v-main class="MTM-150px testing">
        <div id="hero-section" class="indigo lighten-1">
        ...
        <div id="First-section" class="">
            <v-container class="d-flex">
                <v-row>
                    ...
                    <v-col cols="12" md="6" lg="6" id="webdevregestration">
                        <RegestrationForm/>
                    </v-col>
                </v-row>
            </v-container>
