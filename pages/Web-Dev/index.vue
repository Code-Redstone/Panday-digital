<template>
  <v-app>
      <v-main class="pt-100 testing">
            ...
            <v-container class="d-flex 5" >
                <v-row>
                    ...
                    <v-col cols="12" lg="6">
                            ...
                            max-width="700px"
                            max-height="700px"
                            :src="require(`~/assets/resources/20945385.png`)"
                            />
                    </v-col>
                </v-row>
            </v-container>
                ...
                <v-row>
                    <v-col cols="12 d-flex" lg="6"> 
                        <div class="test">
                            ...
                            <p class="font-weight-light text-xl-h6 text-lg-h6 text-md-h6 text-sm-h5">When looking for a web design company in the Philippines, it’s important to consider its portfolio. A well-established, trust-able company must showcase an impressive website with all their projects. A company that is confident about their work and it is ready to demonstrate it.</p> 
        ...
        <div id="Second-section" class="indigo darken-1 h-25% ">
            ...
            <v-container class="d-flex">
                <v-row>
                    ...
                    <v-col cols="12" lg="6">
                            ...
                            max-width="400px"
                            max-height="400px"
                            :src="require(`~/assets/resources/programminglang.png`)"
                            />
                    </v-col>
                </v-row>
            </v-container>
            <svg id="skewed" style="fill:#3949ab; height:100px;background:#fff;" class="w-100 positionR-bottom3 flip Ddn" preserveAspectRatio="none" viewBox="0 0 1442 100" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"> <polygon class="divider-color" points="0 0 1442 0 0 100"></polygon> </svg>
        </div>
            ...
            <v-container class="d-flex">
                <v-row>
                    ...
                    <v-col cols="12" lg="6">
                            ...
                            max-width="550px"
                            max-height="550px"
                            :src="require(`~/assets/resources/marketing_copywriting_102.png`)"
                            />
                    </v-col>
                </v-row>
            </v-container>
        </div>
        <div id="Fourth-section" class="indigo darken-1 ">
            <svg id="skewed" style="fill:#fff; height:100px;" class="w-100 positionR-bottom3 flip Ddn" preserveAspectRatio="none" viewBox="0 0 1442 100" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"> <polygon class="divider-color" points="0 0 1442 0 0 100"></polygon> </svg>
            <v-container class="d-flex">
                <v-row>
                    <v-col cols="12 d-flex" lg="6"  > 
                    ...
                    <v-col cols="12" lg="6">
                            ...
                            max-width="400px"
                            max-height="400px"
                            :src="require(`~/assets/resources/peso.png`)"
                            />
                    </v-col>
                </v-row>
            </v-container>
            ...
            <v-container class="d-flex">
                <v-row>
                    ...
                    <v-col cols="12" lg="6">
                            ...
                            max-width="550px"
                            max-height="550px"
                            :src="require(`~/assets/resources/contemporary-trends.jpg`)"
                            />
                    </v-col>
                </v-row>
            </v-container>
        </div>
        <div id="Sixth-section" class="py-15 indigo lighten-5">
            <v-container class="d-flex">    
                <v-row>
                    ...
                    <v-col cols="12" lg="6">
                            ...
                            max-width="650px"
                            max-height="650px"
                            :src="require(`~/assets/resources/Monitor.jpg`)"
                            />
                    </v-col>
                </v-row>
            </v-container>
